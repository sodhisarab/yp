			...
			<div class="fottoer_last">
				...
				<div class="fottoer_last_2">
					...
					<div class="one_colun last_colun">
						...
						<li><a href="https://www.instagram.com/weareyellowpixel/" class="sl-menu-item">IG</a></li>
						<li><a href="https://twitter.com/beyellowpixel" class="sl-menu-item">TW</a></li>
						<li><a href="https://www.facebook.com/weareyellowpixel" class="sl-menu-item">FB</a></li>
						<li><a href="https://www.linkedin.com/company/yellowpixel" class="sl-menu-item">LN</a></li>
					</ul>
					</div>
				</div>
			</div>
