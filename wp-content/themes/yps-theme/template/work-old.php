  ...
  <main>
    <div class="our_work_page">
      <div class="our_work_page_head">
        ...
        <div class="half2">
          <p><?php the_field('work_page_description'); ?></p>
        </div>
      </div>
    </div>
    <div class="our_work_page_down">
      <div class="our_work_content">
        ...
        <div class="half1">
          <div class="our_work_content_inner">
            ...
            <div class="content | scrollarea-ctn">
                  ...
                  <ul class="slideshow-list">
                            ...
                            <a href="<?php the_permalink(); ?>">
                              <?php 
                                ...
                                <div class="tile__content">
                                  ...
                                  <div class="tile__cta">
                                    <span class="btn-inline"><?php echo esc_attr( $hero['services'] ); ?></span>                                
                                  </div>
                                </div>
                              <?php endif; ?>
                            </a>
                    ...
                    <!-- <li class="slideshow-list__el">
                        <article class="tile | js-tile">
                            <a href="#">
                                <figure class="tile__fig">
                                    <img src="dist/img/tiles/img3.jpg" data-hover="dist/img/tiles/img3hover.jpg" alt="Woods & Forests" class="tile__img">
                                </figure>
                                <div class="tile__content">
                                    <h3 class="tile__title | title title--medium ">M Body Jewelry</span></h3>
                                    <div class="tile__cta">
                                        <span class="btn-inline">Shopify / Design / SEO</span>
                                    </div>
                                </div>
                            </a>
                        </article>
                    ...
                    <!-- <li class="slideshow-list__el">
                        <article class="tile | js-tile">
                            <a href="#">
                                <figure class="tile__fig">
                                    <img src="dist/img/tiles/img6.jpg" data-hover="dist/img/tiles/img6hover.jpg" alt="Rocks & Mountains" class="tile__img">
                                </figure>
                                <div class="tile__content">
                                    <h3 class="tile__title | title title--medium ">Direct Specs</span></h3>
                                    <div class="tile__cta">
                                        <span class="btn-inline">WooCommerce / UX/UI Design / Custom Development</span>
                                    </div>
                                </div>
                            </a>
                        </article>
                    ...
                    <li class="slideshow-list__el">
                        <article class="tile | js-tile">
                            <a href="#">
                                <figure class="tile__fig">
                                    <img src="dist/img/tiles/img9.jpg" data-hover="dist/img/tiles/img9hover.jpg" alt="Cities & Skylines" class="tile__img">
                                </figure>
                                <div class="tile__content">
                                    <h3 class="tile__title | title title--medium ">ProductLink
                                        </spa>
                                    </h3>
                                    <div class="tile__cta">
                                        <span class="btn-inline">Shopify / UX/UI Design / Custom Development</span>
                                    </div>
                                </div>
                            </a>
                        </article>
                    ...
                    <li class="slideshow-list__el">
                        <article class="tile | js-tile">
                            <a href="#">
                                <figure class="tile__fig">
                                    <img src="dist/img/tiles/img12.jpg" data-hover="dist/img/tiles/img12hover.jpg" alt="SAND & DESERTS" class="tile__img">
                                </figure>
                                <div class="tile__content">
                                    <h3 class="tile__title | title title--medium ">Ardor Eyewear
                                        </spa>
                                    </h3>
                                    <div class="tile__cta">
                    ...
                    <li class="slideshow-list__el">
                        <article class="tile | js-tile">
                            <a href="#">
                                <figure class="tile__fig">
                                    <img src="dist/img/tiles/img13.jpg" data-hover="dist/img/tiles/img13hover.jpg" alt="Snow & Mountains" class="tile__img">
                                </figure>
                                <div class="tile__content">
                                    <h3 class="tile__title | title title--medium ">Thread Tales
                                        </spa>
                                    </h3>
                                    <div class="tile__cta">
                                        <span class="btn-inline">Shopify / Design / Custom Development</span>
                                    </div>
                                </div>
                            </a>
                        </article>
      ...
      <div class="box-1" data-scroll-reveal="enter left move 200px over 1s after 0.3s">
        <div class="text-in">
          <div class="section-title left office-text">
            <h2 class="white_cl">Don't Pixelate, Get In Touch!</h2>
            <div class="subtitle left white_cl">We would love to hear from you. Feel free to reach out if<br> you would like to discuss your idea with us.</div>
            <a href="#" class="subtitle-button" role="button">
              <span class="button-text white_cl">hello@weareyellowpixel.com </span>
            </a><a class="subtitle-button"><span class="white_cl">|</span></a>
            <a href="#" class="subtitle-button " role="button">
